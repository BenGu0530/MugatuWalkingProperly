...
void loop() {
  ...
  if (printHeaders) {
    ...
    if (dataFile) {
      ...
      dataFile.println("================================================================");
      dataFile.println((String) "Time [s] " + "Pos [deg] " + "Acutal Pos [deg] " + "Velocity [deg/s] " + "ax " + "ay " + "az " + "gx " + "gy " + "gz ");
      dataFile.close();
    } else {
    ...
    if (dataFile) {
      dataString = (String)current_time + ", " + (String)current_pos + ", " + (String)current_actual_pos + ", " + (String)current_velocity + ", " + (String)ax + ", " + (String)ay + ", " + (String)az + ", " + (String)gx + ", " + (String)gy + ", " + (String)gz;
