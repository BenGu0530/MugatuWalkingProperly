...
float current_gz, prev_gz;
float current_gx, prev_gx;
...
void loop() {
  ...
  if (printHeaders) {
    ...
    if (dataFile) {
      dataString = (String)current_time + ", " + (String)current_pos + ", " + (String)current_actual_pos + ", " + (String)current_velocity + ", " + (String)ax + ", " + (String)ay + ", " + (String)az + ", " + (String)gx + ", " + (String)gy + ", " + (String)gz + ", " + (String)A_left + ", " + (String)A_right + ", " + (String)alpha_x + ", " + (String)f_left + ", " + (String)f_right + ", " + (String)switched_leg;
